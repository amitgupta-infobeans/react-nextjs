...
const Counter = () => {
    ...
    return (
        <div className="flex flex-col gap-2 p-4 m-2 bg-amber-200">
            ...
            <div>
                <input onChange={(e) => setInputCount(Number(e.target.value))} className='px-2 py-1 border mr-2' type='text' value={inputCount} />
